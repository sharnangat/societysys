...
echo ""
echo ""
echo "Note: Replace {member_id} with actual UUID from your database"
echo "You can get a member_id by running: curl -X GET http://localhost:3000/api/members"
