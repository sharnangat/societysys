# PowerShell script to update a member record by membership_number
# Make sure the server is running on http://localhost:3000
# NOTE: Replace {membership_number} with actual membership number from your database

Write-Host "=== Update Member Record by Membership Number ===" -ForegroundColor Green
Write-Host ""
...
Invoke-RestMethod -Uri "http://localhost:3000/api/members/membership/{membership_number}" `
    -Method Put `
    -Body $body1 `
...
Write-Host ""
Write-Host "Note: Replace {membership_number} with actual membership number from your database" -ForegroundColor Cyan
Write-Host "You can get a membership_number by running: Invoke-RestMethod -Uri 'http://localhost:3000/api/members'" -ForegroundColor Cyan
